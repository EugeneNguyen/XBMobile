...
static XBDatabase *__sharedXBDatabase = nil;
...
{
    if (!__sharedXBDatabase)
    {
        __sharedXBDatabase = [[XBDatabase alloc] init];
    }
    return __sharedXBDatabase;
}
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [bundle URLForResource:@"XBMobile" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"XBMobile.sqlite"];
    NSError *error = nil;
